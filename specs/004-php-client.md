...
> Lives in repo 1 (`haidarrais/image-oxide`) until repo 2 exists, then migrates. Header in [005-laravel-bridge.md](../laravel-image-oxide/specs/005-laravel-bridge.md) notes the move.
